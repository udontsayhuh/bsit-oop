...
namespace BasicCalculator // Implementing Pascal Case
{
    // Base Class: Parent
    public class CalculatorOperations // Implementing Pascal Case
    {
    ...
    // Derived Class: Child
    public class Subtraction : CalculatorOperations // Implementing Pascal Case
    {
    ...
    // Derived Class: Child
    public class Multiplication : CalculatorOperations // Implementing Pascal Case
    {
    ...
    // Derived Class: Child
    public class Division : CalculatorOperations // Implementing Pascal Case
    {
    ...
    class BasicCalculatorProgram // Implementing Pascal Case
    {
